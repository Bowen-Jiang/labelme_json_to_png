...
#     print(json_path)
    for i,file_name in enumerate(json_path):
        if file_name.endswith('.json'):
            ...
            # raw = cv2.resize(raw,(320,240), interpolation=cv2.INTER_CUBIC)
...
#             cv2.waitKey(0)
            ...
            #save_filename_use_file_name_noext
            ...
            # save_filename_use_i
            img_raw_file = os.path.join(mask_path + "/rgb_" + str(i).zfill(4) + ".png")
            img_binary_file = os.path.join(mask_path + "/label_" + str(i).zfill(4) + ".png")
